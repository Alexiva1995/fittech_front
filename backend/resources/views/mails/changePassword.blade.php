								...
								<tr>
									<td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
										<div mc:repeatable="Select" mc:variant="Hero">
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td style="font-size:0pt; line-height:0pt; text-align:center; padding-top: 20px;"><img src=https://lh3.googleusercontent.com/-Grx3gdT07TA/XyGhpo5lyYI/AAAAAAAAhTE/s3VSHgZdsawBy29mbojJuOqUmwzU9QKlgCK8BGAsYHg/s0/2020-07-29.png width="240px" height="auto" mc:edit="image_2" style="max-width:100%;" alt="" /></td>
												</tr>
												...
												<tr>
													<td class="p30-15" style="padding: 40px 0px 40px 0px;">
														<table width="100%" border="0" cellspacing="0" cellpadding="0">
															<tr>
																<td style="color:#000000; font-family:Oswald,sans-serif; font-size:30px; line-height:32px; text-align:center; padding-bottom:15px;">
																	<div mc:edit="text_2">Se ha cambiado tu contraseña</div>
																</td>
															</tr>
															<tr>
																<td class="text pb15" style="color:#666666; font-family:Open Sans, sans-serif; font-size:15px; line-height:28px; text-align:center; padding-bottom:15px;">
																	<div mc:edit="text_3">¡Hola! Hemos detectado que cambiaste tu contraseña recientemente. <br><br><b>Si no fuiste tú por favor contáctanos a</b> <b>info@fittech247.com</b></div>
																</td>
															</tr>
