																			...
																			<tbody>
																				<tr>
																					<td class="h3 pb15" style="color:#000000; font-family:Oswald,sans-serif; font-size:30px; line-height:32px; text-align:center; padding-bottom:15px;">
																						<div mc:edit="text_2">¡Nueva Compra FITTECH!</div>
																					</td>
																				</tr>
																				<tr>
																					<td class="text pb15" style="color:#666666; font-family:Open Sans, sans-serif; font-size:15px; line-height:28px; text-align:center; padding-bottom:15px;">
																						<div mc:edit="text_3">
																							El usuario <b>{{$user->name}}</b>, le ha dado comprar el siguiente producto:
																							<br>
																							<center>
																								<h3>{{ $product->name }}</h3>
																								<img src="http://fittech247.com/fittech/imagenes/Productos/{{$product->id}}.png" alt="">
																							</center>
																						</div>
																					</td>
																				</tr>
